...
const locations = [
    ...
    },
    {
        ...
        "button text": ["N", "REPLAY?", "S", "W"],
        "button functions": [restart, restart, restart, restart],
        text: "You escaped the dragon! YOU WIN! 🎉"
    },
    {
        name: "mini game",
        "button text": ["1", "Go Back?", "3", "2"],
        "button functions": [pickOne, goDarkRoom, pickThree, pickTwo],
        text: "You find a secret game. Pick a number above. Ten numbers will be randomly chosen between 0 and 10. If the number you choose matches one of the random numbers, you win (but don't escape the dragon)!"
    },
    {
